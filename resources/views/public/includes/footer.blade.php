              ...
              <div class="cta-heading">
                ...
                <div class="form-area" data-aos="zoom-in" data-aos-duration="1100">
                  <form id="subscription-form">
                    <input type="email" name="email" id="subscription-email" placeholder="Your Email Address" required>
                    <button class="vl-btn1" type="submit">Get Quote <i class="fa-solid fa-arrow-right"></i></button>
                  </form>
                  <div id="subscription-message" style="margin-top: 15px; display: none;"></div>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-xl-3 col-md-6">
          <div class="footer-logo-area">
            <img src="{{ asset('admin_assets/myimages/logo.png') }}" alt="" style="height: 75px;
    border-radius: 7px;
    width: auto;
    filter: none;">
            <div class="space16"></div>
            <p>Abdullah Barakah Ali Al Safari Al Harby Establishment (Alsafri) specializes in all kinds of mild steel & stainless steel fabrication jobs along with extensive experience in escalators' outer cladding and elevators' cabins & doors cladding across Saudi Arabia.</p>
            <div class="space24"></div>
            <ul class="social-links">
              <li><a href="https://www.facebook.com/alsafri4u/" target="_blank"><i class="fa-brands fa-facebook-f"></i></a></li>
        ...
        <div class="col-xl col-md-6">
          ...
          <div class="footer-widget-area foot-padding2">
            <h3>Services</h3>
            <ul>
              <li><a href="{{route('services')}}">Elevator & Escalator Cladding</a></li>
              <li><a href="{{route('services')}}">Steel Fabrication & Structures</a></li>
              <li><a href="{{route('services')}}">Water Tanks & Custom Fabrication</a></li>
        ...
        <div class="col-xl col-md-6">
          ...
          <div class="footer-widget-area">
            ...
            <ul>
              ...
              </svg> P.O. Box: 23717, Al-Johrah Distt., Jeddah 21436, Saudi Arabia</a></li>
              <li><a href="tel:+966-2-2898225"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              </svg> +966-2-2898225</a></li>
              <li><a href="mailto:alsafri4u@gmail.com"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
