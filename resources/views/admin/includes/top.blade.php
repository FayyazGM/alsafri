        ...
        <header class="app-header sticky" id="header">
            ...
            <div class="main-header-container container-fluid">
                ...
                <ul class="header-content-right">
                    ...
                    <li class="header-element header-theme-mode">
                        ...
                        <a href="javascript:void(0);" class="header-link layout-setting">
                            <span class="light-layout">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 header-link-icon"
                    ...
                    <!-- End::header-element -->
                     <!-- Start::header-element -->
                    <li class="header-element cart-dropdown dropdown" style="display: none;">
                        ...
                        <div class="main-header-dropdown dropdown-menu dropdown-menu-end"
                            ...
                            <div class="p-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    <p class="mb-0 fs-15 fw-medium">Cart Items<span
                            ...
                            <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                                    ...
                                    <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                        <div class="lh-1">
                                            <span class="avatar avatar-xl bg-primary-transparent">
                                                <img src="build/assets/images/ecommerce/png/30.png"
                                                ...
                                                <div class="mb-0 fs-14 fw-medium">
                                                    ...
                                                    <div class="text-truncate">
                                                        ...
                                                        <h6 class="fw-medium mb-0 mt-1"><span
                                                                class="text-success fw-normal me-1 fs-11 d-inline-block">(Qty
                                                                : 1)</span>$78</h6>
                                                    </div>
                                                </div>
                                                <div class="text-end">
                                                    ...
                                                    <h6 class="fw-medium mb-0 mt-3"><span
                                                            class="text-info op-4 fw-normal me-1 fs-11 d-inline-block">Total
                                                            :</span>$75</h6>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                        <div class="lh-1">
                                            <span class="avatar avatar-xl bg-primary-transparent">
                                                <img src="build/assets/images/ecommerce/png/29.png"
                                                    alt="Ladies Hand Bag">
                                            </span>
                                        </div>
                                        <div class="flex-fill">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                        <div class="lh-1">
                                            <span class="avatar avatar-xl bg-primary-transparent">
                                                <img src="build/assets/images/ecommerce/png/32.png"
                                                    alt="Elegant Flower Pot">
                                            </span>
                                        </div>
                                        <div class="flex-fill">
                                            <div class="d-flex align-items-center justify-content-between mb-0">
                                                <div class="mb-0 fs-14 fw-medium">
                                                    <a href="cart.html">Elegant Flower Pot</a>
                                                    <div class="text-truncate">
                                                        <p
                                                            class="mb-0 header-cart-text text-truncate fs-11 text-muted">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-0">
                                                <div class="mb-0 fs-14 fw-medium">
                                                    ...
                                                    <div class="text-truncate">
                                                        <p
                                                            class="mb-0 header-cart-text text-truncate fs-11 text-muted">
                                                            Crafted from soft, breathable fabric and adorned with
                                                            delightful </p>
                                                        <h6 class="fw-medium mb-0 mt-1"><span
                                                                class="text-success fw-normal me-1 fs-11 d-inline-block">(Qty
                                                                : 1)</span>$37</h6>
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                        <div class="lh-1">
                                            <span class="avatar avatar-xl bg-primary-transparent">
                                                <img src="build/assets/images/ecommerce/png/16.png" alt="Smart Watch">
                                            </span>
                                        </div>
                                        <div class="flex-fill">
                                            <div class="d-flex align-items-center justify-content-between mb-0">
                            ...
                            <div class="p-3 empty-header-item border-top d-flex gap-2 align-items-center">
                                <a href="checkout.html" class="btn flex-fill btn-primary btn-wave">Proceed to
                                    checkout</a>
                            </div>
                    ...
                    <li class="header-element dropdown">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                            ...
                            <div class="d-flex align-items-center">
                                <div>
                                    <img src="{{ asset('admin_assets/images/faces/15.jpg') }}" alt="img"
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                            ...
                            <li>
                                <div class="dropdown-item text-center border-bottom">
                                    ...
                                    <span class="d-block fs-12 text-muted">{{ ucwords(str_replace('_', ' ', $user->user_type)); }}</span>
                                </div>
                            </li>
                            <li><a class="dropdown-item d-flex align-items-center" href="{{ route('admin.profile.index') }}"><i
                            ...
                            <li class="border-top bg-light"><a class="dropdown-item d-flex align-items-center"
                                    href="https://wa.me/923262522980"><i
