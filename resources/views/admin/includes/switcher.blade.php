            ...
            <div class="offcanvas-body">
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="d-flex justify-content-between canvas-footer flex-nowrap gap-2">
                        <a href="https://themeforest.net/item/xintra-laravel-bootstrap-admin-dashboard-template/54027623" target="_blank" class="btn btn-primary text-nowrap">Buy Now</a> 
